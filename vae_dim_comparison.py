...
if __name__=='__main__':
  ...
  for ldim in [2,3]:
    ...
    tmp=[]
    for c in caseList:
      recon=np.load('./data/VAE/reconstruction/recon.%s.vae61x61_ldim%d_b%.4f_%s_t%dto%d_seed%d_norm%d.npy'%(c,ldim,beta,dataset,du.ts,du.te,seed,int(thd)))
  ...
  plt.savefig('./figures/vae_dim_errors.png')
