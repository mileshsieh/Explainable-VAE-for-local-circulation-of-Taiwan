...
if __name__=='__main__':
    ...
    flow={'WD120':np.load('./data/VAE/flow_WD117.35_WS9.32.npy'),
          'WD150':np.load('./data/VAE/flow_WD148.07_WS9.32.npy')
          }
    plt.close()
    ...
    plt.savefig('figures/fig7_pm25_with_flow.png',dpi=400)