...
if __name__=='__main__':
  ...
  features=['wd925', 'ws925','u925','v925']
  ...
  ax2=plt.subplot(142)
  plt,ax1=plot_mu(plt,ax2,'WS',ws,latent_var,test_cases,train_cases,limit_value,2,10,'Dark2')
  ax3=plt.subplot(143)
  plt,ax1=plot_mu(plt,ax3,'U',u,latent_var,test_cases,train_cases,limit_value,-10,10,'bwr')
  ax4=plt.subplot(144)
  plt,ax1=plot_mu(plt,ax4,'V',v,latent_var,test_cases,train_cases,limit_value,-10,10,'bwr')
  plt.tight_layout()
  ...
  plt.savefig('figures/fig7.1_physical_latent_space.png',dpi=300)
